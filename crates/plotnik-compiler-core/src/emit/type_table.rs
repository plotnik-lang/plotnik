...
//! inferred shape lowers lives in `plotnik-compiler-emit-types`.

use std::collections::HashMap;

use plotnik_bytecode::{TypeDef, TypeDefKind, TypeId as BytecodeTypeId, TypeMember, TypeNameEntry};

use crate::{TypeAnalysis, TypeId};
