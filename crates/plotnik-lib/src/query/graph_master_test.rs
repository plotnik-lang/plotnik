...
fn golden_master_comprehensive() {
    ...
    TaggedCaptured = (113)
    TaggedMulti = (127)
    UntaggedSymmetric = (143)
    UntaggedAsymmetric = (151)
    UntaggedCaptured = (159)
    CapturedSeq = (167)
    UncapturedSeq = (176)
    NestedScopes = (189)
    Identifier = (200)
    ...
    (113) —(wrapper)→ (124)
    (114) —{↘}—𝜀→ (117), (121)
    (117) —(left_node)—[StartVariant(Left), CaptureNode]→ (119)
    (119) —𝜀—[Field(l), EndVariant]→ (125)
    (121) —(right_node)—[StartVariant(Right), CaptureNode]→ (123)
    (123) —𝜀—[Field(r), EndVariant]→ (125)
    (124) —𝜀—[StartObject]→ (114)
    (125) —𝜀—[EndObject]→ (126)
    (126) —{↗¹}—𝜀→ (✓)
    (127) —𝜀—[StartObject]→ (130), (134)
    (130) —(node)—[StartVariant(Simple), CaptureNode]→ (132)
    (132) —𝜀—[Field(val), EndVariant]→ (142)
    (134) —(pair)—[StartVariant(Complex), StartObject]→ (135)
    (135) —{↘}—(key)—[CaptureNode]→ (136)
    (136) —𝜀—[Field(k)]→ (137)
    (137) —{→}—(value)—[CaptureNode]→ (138)
    (138) —𝜀—[Field(v)]→ (140)
    (140) —{↗¹}—𝜀—[EndObject, EndVariant]→ (142)
    (142) —𝜀—[EndObject]→ (✓)
    (143) —𝜀—[StartObject]→ (145), (147)
    (145) —(a)—[CaptureNode]→ (146)
    (146) —𝜀—[Field(val)]→ (150)
    (147) —(b)—[CaptureNode]→ (148)
    (148) —𝜀—[Field(val)]→ (150)
    (150) —𝜀—[EndObject]→ (✓)
    (151) —𝜀—[StartObject]→ (153), (155)
    (153) —(a)—[CaptureNode]→ (154)
    (154) —𝜀—[Field(x)]→ (158)
    (155) —(b)—[CaptureNode]→ (156)
    (156) —𝜀—[Field(y)]→ (158)
    (158) —𝜀—[EndObject]→ (✓)
    (159) —𝜀—[StartObject]→ (161), (163)
    (161) —(a)—[CaptureNode]→ (162)
    (162) —𝜀—[Field(x)]→ (166)
    (163) —(b)—[CaptureNode]→ (164)
    (164) —𝜀—[Field(y)]→ (166)
    (166) —𝜀—[EndObject]→ (✓)
    (167) —(outer)→ (173)
    (168) —{↘}—𝜀→ (169)
    (169) —{→}—(inner)—[CaptureNode]→ (170)
    (170) —𝜀—[Field(x)]→ (171)
    (171) —{→}—(inner2)—[CaptureNode]→ (174)
    (173) —𝜀—[StartObject]→ (168)
    (174) —𝜀—[Field(y), EndObject]→ (175)
    (175) —{↗¹}—𝜀→ (✓)
    (176) —(outer)—[StartObject]→ (177)
    (177) —{↘}—𝜀→ (178)
    (178) —{→}—(inner)—[CaptureNode]→ (179)
    (179) —𝜀—[Field(x)]→ (180)
    (180) —{→}—(inner2)—[CaptureNode]→ (181)
    (181) —𝜀—[Field(y)]→ (184)
    (184) —{↗¹}—𝜀—[EndObject]→ (✓)
    (186) —{→}—𝜀→ (187)
    (187) —{→}—(a)—[CaptureNode]→ (195)
    (189) —𝜀—[StartObject, StartObject]→ (186)
    (192) —{→}—𝜀→ (193)
    (193) —{→}—(b)—[CaptureNode]→ (199)
    (195) —𝜀—[Field(a), EndObject, Field(inner1), StartObject]→ (192)
    (199) —𝜀—[Field(b), EndObject, Field(inner2), EndObject]→ (✓)
    (200) —(identifier)—[CaptureNode]→ (✓)
    (201) —<Identifier>—𝜀→ (200), (202)
    (202) —𝜀—<Identifier>→ (✓)
    (203) —<Identifier>—𝜀→ (200), (204)
    (204) —𝜀—<Identifier>—[CaptureNode]→ (✓)
    (205) —<RefSimple>—𝜀→ (201), (206)
    (206) —𝜀—<RefSimple>→ (✓)
    (207) —𝜀—[StartObject]→ (209), (211)
    (209) —(single)—[CaptureNode]→ (210)
    (210) —𝜀—[Field(item)]→ (223)
    (211) —(multi)→ (213)
    (212) —(x)—[CaptureNode]→ (219)
    (213) —𝜀—[StartArray]→ (217)
    (216) —𝜀→ (✓)
    (217) —{↘}—𝜀→ (212)
    (218) —{→}—𝜀→ (212)
    (219) —𝜀—[PushElement]→ (218), (220)
    (220) —𝜀—[EndArray, Field(item)]→ (221)
    (221) —{↗¹}—𝜀→ (223)
    (223) —𝜀—[EndObject]→ (✓)
    (224) —(_)—[StartObject, CaptureNode]→ (229)
    (225) —(item)—[CaptureNode]→ (232)
    (229) —𝜀—[StartArray]→ (230), (233)
    (230) —{↘}—𝜀→ (225)
    (231) —{→}—𝜀→ (225)
    (232) —𝜀—[PushElement]→ (231), (233)
    (233) —𝜀—[EndArray, Field(inner)]→ (243)
    (235) —𝜀—[StartArray]→ (224)
    (236) —𝜀—[EndArray]→ (✓)
    (240) —𝜀→ (✓)
    (242) —{→}—𝜀→ (224)
    (243) —{↗¹}—𝜀—[EndObject, PushElement]→ (242), (236)
    (244) —(module)—[StartObject]→ (245)
    (245) —{↘}—(identifier)@name—[CaptureNode, ToString]→ (251)
    (247) —(import)—[CaptureNode]→ (254)
    (251) —𝜀—[Field(mod_name), StartArray]→ (252), (255)
    (252) —{→·}—𝜀→ (247)
    (253) —{→}—𝜀→ (247)
    (254) —𝜀—[PushElement]→ (253), (255)
    (255) —𝜀—[EndArray, Field(imports)]→ (256)
    (256) —{→}—(block)@body→ (296)
    (257) —𝜀—[StartObject]→ (258)
    (258) —{→}—𝜀→ (261), (284)
    (261) —(function)—[StartVariant(Func), StartObject, CaptureNode]→ (262)
    (262) —{↘}—(identifier)@name—[CaptureNode, ToString]→ (263)
    (263) —𝜀—[Field(fn_name)]→ (264)
    (264) —{→}—(parameters)@params→ (273)
    (265) —𝜀—[StartObject]→ (266)
    (266) —{→}—(param)—[CaptureNode, CaptureNode]→ (276)
    (273) —𝜀—[StartArray]→ (274), (277)
    (274) —{↘}—𝜀→ (265)
    (275) —{→}—𝜀→ (265)
    (276) —𝜀—[Field(p), EndObject, PushElement]→ (275), (277)
    (277) —𝜀—[EndArray, Field(params)]→ (278)
    (278) —{↗¹}—𝜀→ (279)
    (279) —{→}—(block)@body—[CaptureNode]→ (280)
    (280) —𝜀—[Field(fn_body)]→ (282)
    (282) —{↗¹}—𝜀—[EndObject, EndVariant]→ (299)
    (284) —(class)—[StartVariant(Class), StartObject, CaptureNode]→ (285)
    (285) —{↘}—(identifier)@name—[CaptureNode, ToString]→ (286)
    (286) —𝜀—[Field(cls_name)]→ (287)
    (287) —{→}—(class_body)@body—[CaptureNode]→ (288)
    (288) —𝜀—[Field(cls_body)]→ (290)
    (290) —{↗¹}—𝜀—[EndObject, EndVariant]→ (299)
    (296) —𝜀—[StartArray]→ (297), (300)
    (297) —{↘}—𝜀→ (257)
    (298) —{→}—𝜀→ (257)
    (299) —𝜀—[EndObject, PushElement]→ (298), (300)
    (300) —𝜀—[EndArray, Field(items)]→ (301)
    (301) —{↗¹}—𝜀→ (303)
    (303) —𝜀→ (306), (304)
    (304) —{→}—(block)@body→ (303)
    (306) —{↗·¹}—𝜀—[EndObject]→ (✓)
    ...
    (310) —𝜀→ (313), (316)
    (311) —𝜀→ (✓)
    (313) —(value)—[StartVariant(Some), CaptureNode]→ (314)
    (314) —𝜀—[EndVariant]→ (311)
    (316) —(none_marker)—[StartVariant(None)]→ (317)
    (317) —𝜀—[EndVariant]→ (311)
...
fn golden_type_inference() {
    ...
    (100) —(foo)→ (104)
    (101) —{↘}—𝜀→ (102)
    (102) —{→}—(bar)—[CaptureNode]→ (105)
    (104) —𝜀—[StartObject]→ (101)
    (105) —𝜀—[Field(bar), EndObject]→ (106)
    (106) —{↗¹}—𝜀→ (✓)
...
fn golden_effect_patterns() {
    ...
    (14) —𝜀—[Field(x)]→ (15)
    (15) —{→}—(b)—[CaptureNode]→ (18)
    (18) —𝜀—[Field(y), EndObject]→ (✓)
    (19) —𝜀—[StartObject]→ (22), (26)
    (22) —(a)—[StartVariant(A), CaptureNode]→ (24)
    (24) —𝜀—[Field(x), EndVariant]→ (30)
    (26) —(b)—[StartVariant(B), CaptureNode]→ (28)
    (28) —𝜀—[Field(y), EndVariant]→ (30)
    (30) —𝜀—[EndObject]→ (✓)
    (31) —(container)→ (33)
    (32) —(item)—[CaptureNode]→ (36)
    (33) —𝜀→ (32), (35)
    (35) —𝜀—[ClearCurrent]→ (36)
    (36) —{↗¹}—𝜀→ (✓)
