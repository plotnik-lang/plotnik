...
pub use bytecode::{
    ...
    EntrypointsView, FieldSymbol, Header, Instruction, LineBuilder, MAGIC, MAX_MATCH_PAYLOAD_SLOTS,
    MAX_PRE_EFFECTS, Match, MatchInstr, MatchPredicate, Module, ModuleError, Nav, NodeSymbol,
    NodeTypeIR, Opcode, RegexView, Return, SECTION_ALIGN, STEP_SIZE, SectionOffsets, Slice,
    StepAddr, StepId, StringId, StringsView, Symbol, SymbolsView, Trampoline, TypeData, TypeDef,
