...
fn nav_byte_encoding() {
    ...
    assert_eq!(Nav::NextSkipExtras.to_byte(), 0b00_000101);
    assert_eq!(Nav::Down.to_byte(), 0b00_000111);
    assert_eq!(Nav::DownSkipExtras.to_byte(), 0b00_001001);
    assert_eq!(Nav::UpSkipExtras(3).to_byte(), 0b00_001101);
...
#[test]
#[should_panic(expected = "UpSkipExtras level overflow")]
fn nav_up_skip_extras_overflow_panics() {
    Nav::UpSkipExtras(54).to_byte();
}
